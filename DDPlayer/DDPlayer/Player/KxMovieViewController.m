...
- (void) enableAudio: (BOOL) on
{
    ...
    if (on && _decoder.validAudio) {
        ...
        audioManager.outputBlock = ^(float *outData, UInt32 numFrames, NSInteger numChannels) {
            
            [self audioCallbackFillData: outData numFrames:numFrames numChannels:(UInt32)numChannels];
        };
